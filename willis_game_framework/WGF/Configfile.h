...
namespace WGF
{
    ...
    class Configfile
    {
        public:
            ...
            \param clear whether to clear the file first, default is false which means that every value that already exists in the file will be changed to the new one and the others will be kept.
            \return success **/
            bool SaveToFile(const std::string& filename, bool clear = false);
