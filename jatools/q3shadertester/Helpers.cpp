...
namespace Helpers
{
    ...
    {
        std::cout<<"Helpers::Replace(\""<<text<<"\", \""<<pattern<<"\", \""<<replace<<"\");"<<std::endl;
        std::cout<<"\\:"<<(int)'\\'<<"\t"<<text[2]<<":"<<(int)text[2]<<std::endl;
        ...
        {
            std::cout<<"Pattern ("<<pattern<<") contains replace ("<<replace<<")! Aborting."<<std::endl;
            return text;
        }
        ...
        {
            //replace it
            std::cout<<"Found \""<<match<<"\" in \""<<result<<".";
            result.erase(match, pattern.length());
            result.insert(match, replace);
            std::cout<<" Now replaced with \""<<replace<<"\", result: \""<<result<<"\"."<<std::endl;
